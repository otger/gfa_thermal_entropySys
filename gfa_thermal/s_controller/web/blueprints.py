...
def get_blueprint(mod_name):
    ...
    tc08bp = GFAControllerBluePrint(mod_name, __name__,
                                    template_folder='templates')

    return tc08bp


class GFAControllerBluePrint(EntropyBlueprint):
    ...
    def index(self):
        try:
            ...
            return self.render_template('controller/index.html', data=data)
        except TemplateNotFound:
            abort(404)
